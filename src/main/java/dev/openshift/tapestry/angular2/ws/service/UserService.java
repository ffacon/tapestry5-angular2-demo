...
import dev.openshift.tapestry.angular2.data.user.RoleEnum;
import dev.openshift.tapestry.angular2.data.user.Token;
import dev.openshift.tapestry.angular2.services.UserDAO;
